...
// os.ModePerm. Contract: every mode this package hands to open(2) consists of
// the nine POSIX permission bits and nothing else, on every path.
//
// Go's os.FileMode encodes setuid, setgid, sticky and the file-type bits at
// its own positions (1<<23 and above) rather than at the POSIX ones. Passing
