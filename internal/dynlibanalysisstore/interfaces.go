...
// DynamicLibAnalysisStore provides storage and retrieval for dynamic library
// analysis results, keyed by library path and hash.
...
// LibraryAnalyzer performs the actual analysis of a dynamic library file.
// Implementations are provided by callers (e.g., filevalidator.Validator).
type LibraryAnalyzer interface {
	AnalyzeLibrary(libPath string) (*DynamicLibAnalysisResult, error)
}
