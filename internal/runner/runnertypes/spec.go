...
type GlobalSpec struct {
	...
	OutputSizeLimit     *int64   `toml:"output_size_limit"`     // Maximum output size in bytes (nil=use default, 0=unlimited)
...
type CommandSpec struct {
	...
	OutputSizeLimit *int64 `toml:"output_size_limit"` // Command-specific output size limit in bytes (nil=inherit from global, 0=unlimited)
