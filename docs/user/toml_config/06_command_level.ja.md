...
2. **テンプレート使用**: 事前定義されたテンプレートを参照する方法（[第11章](11_command_templates.ja.md)で詳細を説明）
...
> **詳細**: テンプレート機能の詳細（パラメータ展開の種類、エスケープ、ベストプラクティスなど）については[第11章: コマンドテンプレート](11_command_templates.ja.md)を参照してください。
