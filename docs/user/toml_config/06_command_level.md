...
# Executes in the temporary directory generated by the runner
```
...
# Command 3: Delete old backups (execute in temporary directory)
[[groups.commands]]
name = "cleanup_old_backups"
description = "Delete backup files older than 30 days"
cmd = "/usr/bin/find"
args = ["/var/backups/db", "-name", "*.sql", "-mtime", "+30", "-delete"]
workdir = "%{__runner_workdir}"  # Execute safely in temporary directory
