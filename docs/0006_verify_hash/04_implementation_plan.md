...
- [ ] **Task 1.1**: config/loader.go に警告ログ追加
  - **担当**: 開発者
  - **工数**: 0.5日
  - **依存**: なし
  - **成果物**: 警告ログ実装

- [ ] **Task 1.2**: README.md セキュリティセクション更新
  - **担当**: 開発者
  - **工数**: 0.5日
  - **依存**: Task 1.1
  - **成果物**: 更新されたREADME.md

- [ ] **Task 1.3**: --verify-config オプションのヘルプ追加
  - **担当**: 開発者
  - **工数**: 0.5日
  - **依存**: なし
  - **成果物**: 更新されたヘルプメッセージ
...
- [ ] 警告ログが適切に出力される
- [ ] README.md にセキュリティ制限が明記される
- [ ] --verify-config オプションが存在し、未実装メッセージを表示
- [ ] 既存機能に影響がない
- [ ] すべてのテストが通過する
