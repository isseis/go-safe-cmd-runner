...
| タスク | 説明 | 所要時間 | 依存関係 |
|--------|------|----------|----------|
| GE-1.1 | `group_executor_options.go` 作成 | 2h | なし |
| GE-1.2 | Option 関数実装 | 4h | GE-1.1 |
| GE-1.3 | 新しい `NewDefaultGroupExecutor` 実装 | 3h | GE-1.2 |
| GE-1.4 | 既存関数をレガシー関数へリネーム | 1h | GE-1.3 |
| GE-1.5 | テストヘルパー関数実装 | 3h | GE-1.3 |
| GE-1.6 | ユニットテスト作成 | 4h | GE-1.5 |
...
| タスク | 説明 | 所要時間 | 依存関係 |
|--------|------|----------|----------|
| GE-2.1 | プロダクションコード移行 | 2h | Phase 1完了 |
| GE-2.2 | 統合テスト実行・修正 | 3h | GE-2.1 |
| GE-2.3 | パフォーマンステスト | 2h | GE-2.2 |
| GE-2.4 | プロダクション動作確認 | 1h | GE-2.3 |
...
| タスク | 説明 | 所要時間 | 依存関係 |
|--------|------|----------|----------|
| GE-3.1 | パターン1移行（15箇所） | 6h | Phase 2完了 |
| GE-3.2 | パターン2移行（5箇所） | 3h | GE-3.1 |
| GE-3.3 | パターン3移行（2箇所） | 3h | GE-3.2 |
| GE-3.4 | 全テスト実行・修正 | 4h | GE-3.3 |
| GE-3.5 | テスト品質確認 | 2h | GE-3.4 |
...
| タスク | 説明 | 所要時間 | 依存関係 |
|--------|------|----------|----------|
| GE-4.1 | レガシー関数削除 | 1h | Phase 3完了 |
| GE-4.2 | ドキュメント更新 | 3h | GE-4.1 |
| GE-4.3 | 最終テスト実行 | 2h | GE-4.2 |
| GE-4.4 | コードレビュー対応 | 3h | GE-4.3 |
