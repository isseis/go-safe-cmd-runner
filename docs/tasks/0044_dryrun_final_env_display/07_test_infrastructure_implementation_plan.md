...
- [ ] **Task 2.3**: T2.1 - dry-run DetailLevelFull テスト
  - [ ] テストケース実装
  - [ ] 標準出力キャプチャの実装
  - [ ] 環境変数出力の検証
  - [ ] センシティブデータマスキングの確認
...
- [ ] **Task 2.4**: T2.2 - dry-run 変数展開デバッグテスト
  - [ ] テストケース実装
  - [ ] デバッグ情報出力の検証
  - [ ] from_env継承の確認
  - [ ] lint, testチェック

- [ ] **Task 2.5**: Phase 2 カバレッジ測定
  - [ ] executeCommandInGroupのカバレッジ確認
  - [ ] ExecuteGroupのカバレッジ確認
  - [ ] 全体カバレッジの測定
  - [ ] 結果をドキュメントに記録
