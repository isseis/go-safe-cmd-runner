...
- [ ] README.mdが更新されている（別タスクで実施予定）
- [ ] ユーザー向けドキュメントが完全（別タスクで実施予定）
- [ ] CHANGELOG.mdが更新されている（別タスクで実施予定）
- [ ] サンプルファイルが更新されている（別タスクで実施予定）
- [x] godocコメントが完全
...
- [x] リンターチェックが通過する
- [ ] ドキュメントが完全（別タスクで実施予定）
- [ ] CHANGELOGが更新されている（別タスクで実施予定）
- [-] マイグレーションガイド（必要な場合）が作成されている（不要 - 既存機能との互換性あり）
