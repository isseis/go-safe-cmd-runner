...
- 対象: `docs/user/` 配下で `verify_standard_paths`/`skip_standard_paths` を参照しているドキュメント
  ...
  - `docs/user/toml_config/README.md`（および日本語版）
...
| `docs/user/runner_command.md`（+日本語版）、`docs/user/toml_config/README.md`（+日本語版）、`docs/user/toml_config/09〜11_*.md`（+日本語版）、`docs/user/toml_config/appendix.md`（+日本語版） | `verify_standard_paths` への言及 |
